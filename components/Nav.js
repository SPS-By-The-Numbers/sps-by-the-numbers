    ...
    <nav className="bg-gray-800">
                 ...
                 <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                     <div className="hidden sm:block sm:ml-6">
                         ...
                         <a href="//sps-by-the-numbers.com" className="text-gray-300 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">
                             ...
                             <a href="/seattle-city-council" className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Seattle City Council Transcripts</a>
                         </div>
                     </div>
                 </div>
        ...
        <div className="sm:hidden" id="mobile-menu">
            <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <a href="//sps-by-the-numbers.com" className="text-gray-300 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">Main site</a>
                <a href="/sps-board" className="text-gray-300 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page">SPS Board Transcripts</a>
                <a href="/seattle-city-council" className="text-gray-300 text-white px-3 py-2 rounded-md text-sm font-medium">Seattle City Council Transcripts</a>
